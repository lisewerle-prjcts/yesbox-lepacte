...
export const MODULES: ModuleInfo[] = [
  {
    ...
    description: 'Avant de former un couple, tu appartiens à un modèle. On commence par toi — tes réponses seront comparées à ce que ton/ta partenaire devine de toi.',
    emoji: '🪞', free: true,
    questions: [
      ...
      { slug: 'souvenir', type: 'text', texte: 'Quel est ton plus beau souvenir avec ton/ta partenaire ?', hint: 'Celui qui te revient en premier.' },
      { slug: 'admire', type: 'text', texte: 'Qu\'est-ce que tu admires le plus chez toi ?', hint: 'Sois précis·e — pas juste « tout ».' },
      { slug: 'ressource', type: 'choix', texte: 'Quand tu vas mal, ce dont tu as le plus besoin, c\'est…', options: ["Qu'on m'écoute sans rien résoudre", "Qu'on m'aide à trouver une solution", "Qu'on me laisse seul·e un moment", "Un câlin, sans mots"] },
      { slug: 'craintes', type: 'choix_multiple', texte: "Qu'est-ce qui t'inquiète le plus pour l'avenir ?", options: ["L'argent", "La santé des proches", "Notre équilibre à deux", "Le travail / la carrière", "Devenir parent", "Le temps qui passe"] },
      { slug: 'surprise', type: 'text', texte: 'Une chose sur toi que ton/ta partenaire ne sait peut-être pas encore ?', hint: '' },
    ],
  },
  {
    slug: 'toi', n: 2,
    ...
    questions: [
      ...
      { slug: 'bonheur', type: 'choix', texte: 'Pour ton/ta partenaire, le bonheur ressemble le plus à…', options: ["Un moment de calme, seul·e ou à deux", "Une grande tablée qui rit", "Un projet qui avance", "L'imprévu, l'aventure"] },
      { slug: 'heureux', type: 'echelle', texte: "Selon toi, sur une échelle de 1 à 10, ton/ta partenaire est-il/elle heureux·se en ce moment ?", min: 1, max: 10, labelMin: 'Pas vraiment', labelMax: 'Pleinement' },
      { slug: 'plaisirs', type: 'text', texte: 'Selon toi, quels sont les petits plaisirs du quotidien de ton/ta partenaire ?', hint: 'Les minuscules choses qui, selon toi, lui font du bien.' },
      { slug: 'souvenir', type: 'text', texte: 'Selon toi, quel est le plus beau souvenir que garde ton/ta partenaire de votre couple ?', hint: 'Essaie de deviner celui qui lui revient en premier.' },
