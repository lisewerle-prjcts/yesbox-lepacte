...
import { Menu, X, LogOut, LayoutDashboard, ScrollText, BookOpen, UserPlus, ShieldCheck, User } from 'lucide-react'
...
export default function DashboardNav({ profile }: DashboardNavProps) {
  ...
  const links = [
    ...
    { href: '/profil', label: 'Mon profil', icon: <User className="w-4 h-4" /> },
